...
`docs/archive/phase1b-continuum/continuum-vllm-observation-evidence.md` for the committed runtime
evidence and scope.
...
`docs/archive/phase1b-continuum/phase1b-continuum-implementation-decisions.md`. The current Core does
...
- no Phase 1B production GPU integration is claimed; PR 3 runtime evidence is
  recorded separately in `docs/archive/phase1b-continuum/continuum-vllm-observation-evidence.md`.
